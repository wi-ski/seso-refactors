...
export const ${"TEMPLATE_PROVIDER_NAME"}: TSeso.TDDD.application.TApplicationService<${"TEMPLATE_PARAMS_TYPE_NAME"}, ${"TEMPLATE_RESPONSE_TYPE_NAME"}> = (
  $r,
...
`;
export const buildProviderApplicationService: TSourceFileConfiguratorFn = (
  p
) => {
