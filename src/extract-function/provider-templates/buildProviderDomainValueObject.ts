...
export const ${"TEMPLATE_PROVIDER_NAME"}: TSeso.TDDD.domain.TDomainValueObject<${"TEMPLATE_RESPONSE_TYPE_NAME"}, ${"TEMPLATE_PARAMS_TYPE_NAME"}> = (
  $r,
...
`;
export const buildProviderDomainValueObject: TSourceFileConfiguratorFn = (
  p
) => {
